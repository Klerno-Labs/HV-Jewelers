    ...
    <>
      ...
      <AdminPageBody>
        ...
        <p className="mt-6 max-w-2xl text-caption leading-relaxed text-ink-muted">
          Most fine-jewelry pieces default to a 15-day window in original,
          unused condition. Custom, engraved, and resized pieces are final
          sale; resizing voids the return window per the resize-voids-return
          flag on the product. Damage and not-as-described claims follow a
